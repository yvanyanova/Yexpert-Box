...
usage()
{
    ...
    Ce script permet de créer une partititon DMO pour Yexpert
...
# Copier les répertoires standards du dépot Yexpert-DMO
su $instance -c "cp -R $basedir/src/Yexpert-DMO/scripts $partdir"
...
echo "La partition DMO d'Yexpert de l'instance $instance est créée..."
