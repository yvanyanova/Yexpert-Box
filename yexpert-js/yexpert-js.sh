...
echo "4/31 react-json-inspector"
...
su $instance -c "source $basedir/.nvm/nvm.sh && source $basedir/config/env && nvm use $nodever && cd $basedir/www/yexpert && npm install --quiet -g babel-preset-es2015 >> $basedir/log/installerBabel-preset-es2015.log"
